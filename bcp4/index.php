      ...
      <div class="bx-wrapper" style="margin: 0px auto; max-width: 100%;">
        <div class="bx-viewport" style="width: 100%; height: 600px; overflow: hidden; position: relative;">
          <ul class="top-banner" style="width: auto; position: relative; transform: translate3d(0px, -1624.62px, 0px); transition-duration: 0s;">
           <li class="bx-clone" style="list-style: none; width: 1366px; float: none; position: relative;"><img alt="#" src="images/111.jpg"> </li>
           <li style="list-style: none; width: 1366px; float: none; position: relative;"><img alt="#" src="images/111.jpg"> </li>
           <li style="list-style: none; width: 1366px; float: none; position: relative;"><img alt="#" src="images/112.jpg"> </li>
            <li style="list-style: none; width: 1366px; float: none; position: relative;"><img alt="#" src="images/113.png"> </li>  
            <li style="list-style: none; width: 1366px; float: none; position: relative;"><img alt="#" src="images/112.jpg"> </li>
            ...
            <div class="bx-viewport" style="width: 100%; height: 200px; overflow: hidden; position: relative;">
              <ul class="bottom-sec" id="bottom-sec" style="left: -1839px; width: 515%; position: relative;">
                <li class="inner-bottom-sec bx-clone" style="list-style: none; width: 600px; float: left; position: relative;">
                  <h2>No1 in Asia for joint & hip replacement.</h2>
                  <p>Precision german based technology first time in India</p>
                  ...
                  <p>We done More than 5000+ joint replacements in Germany & India</p>
                  <a href="about.php">READ MORE</a> </li>
                  
                  <li class="inner-bottom-sec" style="list-style: none; width: 600px; float: left; position: relative;">
                  <h2>Leading orthopedic & joint replacement, sports injury trauma center in India</h2>
                 <!-- <p>Expertise in joint, knee replacement & .</p>-->
                  <a href="joint-replacement.php">READ MORE</a> </li>
                  
                   <li class="inner-bottom-sec" style="list-style: none; width: 600px; float: left; position: relative;">
                  <h2>No1 Multi speciality services in asia</h2>
                  <p>You are in safe hands, you're bound to get relief.</p>
                  <a href="spine-surgery.php">READ MORE</a> </li>
                  
                   <li class="inner-bottom-sec" style="list-style: none; width: 600px; float: left; position: relative;">
                  <h2>Knee & Hip replacement </h2>
                  <p>With computer navigation & robotics first time in India</p>
                ...
                <div class="flexsilder" id="testimonial-carousel">
                  <div class="flex-viewport" style="overflow: hidden; position: relative;">
                    <ul class="slides" style="width: 1200%; transform: translate3d(-136px, 0px, 0px); transition-duration: 0s;">
                      <li style="width: 63px; float: left; display: block;"> <a href="#"><img draggable="false" alt="" src="images/testimonial-img-1.png"></a> </li>
                      <li style="width: 63px; float: left; display: block;"> <a href="#"><img draggable="false" alt="" src="images/testimonial-img-1.png"></a> </li>
                      <li style="width: 63px; float: left; display: block;"> <a href="#"><img draggable="false" alt="" src="images/testimonial-img-1.png"></a> </li>
                      <li style="width: 63px; float: left; display: block;"> <a href="#"><img draggable="false" alt="" src="images/testimonial-img-1.png"></a> </li>
                      <li style="width: 63px; float: left; display: block;"> <a href="#"><img draggable="false" alt="" src="images/testimonial-img-1.png"></a> </li>
                      <li class="flex-active-slide" style="width: 63px; float: left; display: block;"> <a href="#"><img draggable="false" alt="" src="images/testimonial-img-1.png"></a> </li>
                    </ul>
                  </div>
                  <ul class="flex-direction-nav">

...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( // WPCS: XSS OK.
					esc_html( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'viralblog-lite' ) ),
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			<h2 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'viralblog-lite' ); ?></h2>
			<div class="nav-links">

				<div class="nav-previous"><?php previous_comments_link( esc_html__( '<i class="fa fa-angle-double-left"></i> Older Comments', 'viralblog-lite' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments <i class="fa fa-angle-double-right"></i>', 'viralblog-lite' ) ); ?></div>
	...
	?>
		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'viralblog-lite' ); ?></p>
	<?php endif; ?>

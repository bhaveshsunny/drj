...
<title>Best Spinal Cord Specialist in Hyderabad |Spine Surgeon Hyderabad</title>
...
<div class="testi_section">
 <div class="row">
  ...
  <iframe width="560" height="315" src="https://www.youtube.com/embed/uGqmbYURbjI" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>
    ...
    <p>
   Laser Endoscopic Spine Surgery Dr.Mir jawad Zar Khan
    </p>
   </div>
   <div class="col-md-3 inner-page-video-box clearfix">
    <div class="viceo_box">
  <iframe width="560" height="315" src="https://www.youtube.com/embed/Otlq2exVwCU" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>
    </div>
    <p>
   Vertebroplasty and Kyphoplasty Dr.Mir jawad Zar khan
    </p>
   </div>
   <div class="col-md-3 inner-page-video-box clearfix">
    <div class="viceo_box">
   ...
   <iframe width="560" height="315" src="https://www.youtube.com/embed/IjiYtGtpKl8" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>
    ...
    <p>
   IVas Procedure Animation
    </p>
   </div>
   <div class="clr"></div>
   <div class="col-md-3 inner-page-video-box clearfix">
    <div class="viceo_box">
   <iframe width="560" height="315" src="https://www.youtube.com/embed/Bm-MYMM2DBY" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>
    </div>
    <p>
   Lumbar Stenosis Decompression Animation - Elara Systems
    </p>
   </div>
   <div class="col-md-3 inner-page-video-box clearfix">
    <div class="viceo_box">
   <iframe width="560" height="315" src="https://www.youtube.com/embed/m3Y6oE_AncQ" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>
    </div>
    <p>
...
<li>Facet Arthropathy</li>
                           ...
                           Fluoroscopic / Ultrasound / Endoscopic/ CT guided procedures:
                            ...
                            <li>Facet(Cervical / Thoracic / Lumbar) RF Denervation, Facet Joint Blocks</li>
                            <li>Vertebroplasty, Balloon Kyphoplasty, Sacroplasty</li>
                            <li>Ozonucleolysis (Cervical / Thoracic / Lumba)</li>
                            <li>Trigeminal/ Sphenopalatine / Glossopharyngeal RF / Chemical Blocks</li>
                            <li>Stellate Ganglion Sympathectomy (RF/Chemical)</li>
                            <li>Celiac Plexus / Splanchnic / Superior Hypogastric / Impar Blocks (RF/Chemical)</li>
                            <li>Lumbar/ Thoracic / T2, T3 Sympathectomy (RF / Chemical)</li>
                            <li>Intrathecal / Epidural Catheter & Pumps, SCS & Lead Placement</li>
							...
							<li>Phylogenic infections or Tuberculosis(most common) or any other</li>
